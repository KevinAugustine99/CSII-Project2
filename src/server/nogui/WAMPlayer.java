...
/**WAMPlayer represents the player for the server
 *
...
public class WAMPlayer extends Thread implements WAMProtocol , Closeable{
     ...
     * @param col the cols of the game
    ...
    public void run() {
        while (run){
            ...
            if(commandPees[0].equals(WHACK))
            {
                ...
                game.whack(Integer.parseInt(commandPees[1]), this); //todo god dammit kevin, mole id is [1] not [2]
            }else break;
        }
    }
}
